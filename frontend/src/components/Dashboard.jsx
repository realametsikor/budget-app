// src/components/Dashboard.jsx — upgraded UX version
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen text-gray-100" style={{ background: "#030712", fontFamily: "'DM Sans', sans-serif" }}>
      <link href="[https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700&display=swap](https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700&display=swap)" rel="stylesheet" />
