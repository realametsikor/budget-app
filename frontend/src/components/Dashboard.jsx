...
export default function Dashboard() {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: "Planned",
        data: [s.income?.planned, s.bills?.planned, s.debts?.planned, s.variableExpenses?.planned, s.savings?.planned],
        backgroundColor: "rgba(99,102,241,0.75)",
        borderRadius: 5,
      },
      {
        label: "Actual",
        data: [s.income?.actual, s.bills?.actual, s.debts?.actual, s.variableExpenses?.actual, s.savings?.actual],
