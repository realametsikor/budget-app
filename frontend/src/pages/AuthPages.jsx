...
// Login and Register pages — dark luxury aesthetic matching homepage
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#080808", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <nav className="flex items-center justify-between px-6 py-5">
        <button onClick={() => navigate("/")} className="flex items-center gap-2">
          <span>💰</span>
          <span style={{ fontFamily: "'Playfair Display', serif", color: "#D4AF37", fontSize: "1.1rem", fontWeight: 700 }}>BudgetTracker</span>
        </button>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          {/* Glow */}
          <div className="absolute blur-3xl opacity-10 w-64 h-64 rounded-full -translate-x-1/2 -translate-y-1/2 pointer-events-none" style={{ background: "#D4AF37" }} />
          ...
          <div className="relative rounded-2xl p-8 md:p-10" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(212,175,55,0.2)" }}>
            <div className="text-center mb-8">
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.9rem", fontWeight: 700, color: "#fff" }}>{title}</h1>
